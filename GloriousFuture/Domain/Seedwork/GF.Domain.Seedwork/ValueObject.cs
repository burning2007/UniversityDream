...
namespace GF.Domain.Seedwork
{
        ...
        where TValueObject : ValueObject<TValueObject>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            ValueObject<TValueObject> entity = obj as ValueObject<TValueObject>;
            
            if ((object)entity != null)
                return Equals((TValueObject)entity);
            else
                return false;
        ...
        public override int GetHashCode()
        {
            ...
            if ((object)publicProperties != null
                ...
                publicProperties.Any())
            {
                foreach (var entity in publicProperties)
                {
                    object value = entity.GetValue(this, null);
